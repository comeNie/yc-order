...
public final class SequenceUtil {
	...
	private static final String ORD_OD_RECEIVE$ID$SEQ = "ORD_OD_RECEIVE$ID$SEQ";
	...
	public static Long createOrdReceiveId() {
		return SeqUtil.getNewId(ORD_OD_RECEIVE$ID$SEQ);
	}
