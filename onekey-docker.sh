...
docker build -t 10.19.13.18:5000/yc-order:${tagversion} .   
docker push 10.19.13.18:5000/yc-order:${tagversion} 

docker rmi aioptapp/yc-order:${tagversion} 
docker tag 10.19.13.18:5000/yc-order:${tagversion} aioptapp/yc-order:${tagversion} 
